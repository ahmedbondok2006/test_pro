            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/adminpanel/category/addCategory" method="post" enctype="multipart/form-data" role="form">
                            {{ csrf_field() }}
                            ...
                            <div class="card-body">
                                <div class="form-group {{ $errors->has('name_ar') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::text('name_ar', old('name_ar'), ['placeholder'=> 'اسم التصنيف','class' => "form-control" ,'id' => "exampleInputEmail1"]) !!}
{{--                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="اسم التصنيف" name="name_ra">--}}
...
{{--                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="اسم التصنيف" name="name_ra">--}}
                                ...
                                <div class="form-group {{ $errors->has('parent_id') ? 'has-error' : '' }}">
                                    <select name="parent_id" class="form-control select2" style="width: 100%;">
                                        <option selected="selected" value="0">اختيار التصنيف الأب</option>
                                        @foreach ($allCategories as $key => $pack_type)
                                            <option value="{{$key}}">{{$pack_type}}</option>
                                        @endforeach
                                    </select>
